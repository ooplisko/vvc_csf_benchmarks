...
1. [neutral_16_verification.md](neutral_16_verification.md) verifies from upstream VVenC source code that [`LOG2_SCALING_LIST_NEUTRAL_VALUE = 4`](https://github.com/fraunhoferhhi/vvenc/blob/6f767486ba2199d9f3f8a75b7739995bd3ed9034/source/Lib/CommonLib/CommonDef.h#L381), so the neutral scaling-list entry is `16`.
...
CSV: [`docs/matrices/neutral_16_control.csv`](neutral_16_control.csv)
